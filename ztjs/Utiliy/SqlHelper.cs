...
namespace SufeiUtil
{
    ...
    public abstract class SqlHelper
    {
        ...
        /// 数据库连接字符串
        /// </summary>
        public static readonly string connectionString = ConfigurationManager.ConnectionStrings["sysDataBase"].ConnectionString;
        //public static readonly string connectionString =ConfigurationManager.AppSettings["sysDataBase"].ToString();  
        //System.Configuration.ConfigurationSettings.AppSettings["sysDataBase"].ToString().Trim();
